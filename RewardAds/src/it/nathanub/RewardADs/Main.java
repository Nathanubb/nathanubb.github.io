...
public class Main extends JavaPlugin {
	...
	public void onEnable() {
		...
		if(new DB().getServerName() != null) {
			...
			if(new GetConfig().isAnnouncerEnabled()) Bukkit.getScheduler().scheduleSyncRepeatingTask(Main.getInstance(), new Announcer(), 10, 20 * new GetConfig().getAnnouncesDelay());
